...
class Dens2bBatt:
    ...
    def __init__(self, density, set_z, physical_side_length, resolution, free_params, flow=True, debug=False,
        ...
        self.astro_params = [self.b_0, jnp.log10(self.k_0), self.alpha] # b0, logk0, alpha
...
if __name__ == "__main__":
    ...
    density = jnp.ones((256, 256))  # placeholder density field
    model = Dens2bBatt(
    ...
    # Process the data
    dTb_box, zre_box, true_dens = model.process_data()
