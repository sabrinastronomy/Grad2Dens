#!/bin/bash
#SBATCH --job-name=run_no_effects
#SBATCH --gres=gpu
#SBATCH --time=5:00:00
#SBATCH --mem=100G
#SBATCH -D /fred/oz113/sberger/paper_1_density/Grad2Dens/src
#SBATCH -o run_no_effects.out
#SBATCH -e run_no_effects.err
...
python /fred/oz113/sberger/paper_1_density/Grad2Dens/src/alternating.py